              ...
              <div class="card-body p-4">
                <form @submit.prevent="onSubmit">
                  ...
                  <div role="group" class="input-group mb-3">
                    ...
                    <input type="text" :readonly="!edit" :class="edit? 'form-control' : 'form-control-plaintext' " class="" id="nombre" v-model="userData.nombre" value="">
                  </div>

                  <div role="group" class="input-group mb-3">
                    <label for="apellido" class="col-sm-6 col-form-label">Apellido</label>
                    <input type="text" :readonly="!edit" :class="edit? 'form-control' : 'form-control-plaintext' " id="apellido" v-model="userData.apellido" value="">
                  </div>
                  ...
                  <div role="group" class="input-group mb-3">
                    ...
                    <input type="text" :readonly="!edit" :class="edit? 'form-control' : 'form-control-plaintext' " id="telefono" v-model="userData.telefono" value="">
                  </div>

                  <div role="group" class="input-group mb-3">
                    <label for="institucion" class="col-sm-6 col-form-label">Institución</label>
                    <input type="text" :readonly="!edit" :class="edit? 'form-control' : 'form-control-plaintext' " id="institucion" v-model="userData.institucion" value="">
                  </div>

                  <div role="group" class="input-group mb-3">
                    <label for="pais" class="col-sm-6 col-form-label">Pais</label>
                    <input type="text" :readonly="!edit" :class="edit? 'form-control' : 'form-control-plaintext' " id="pais" v-model="userData.pais" value="">
                  </div>
                  ...
                  <button v-if="edit" type="submit" class="btn btn-primary btn-block mt-2">Guardar cambios</button>
